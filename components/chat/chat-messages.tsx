...
export const ChatMessages = ({
    ...
    const chatRef = useRef<ElementRef<"div">>(null) as React.RefObject<HTMLDivElement>;
    const bottomRef = useRef<ElementRef<"div">>(null) as React.RefObject<HTMLDivElement>;
    ...
    //activate chat scroll hook here
    useChatScroll({
        chatRef,
        bottomRef,
    ...
    return (
        <div ref={chatRef} className="flex-1 flex flex-col py-5 overflow-y-auto">
