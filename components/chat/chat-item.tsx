...
export const ChatItem = ({
    ...
    const onMemberClick = () => {
        ...
        router.push(`/servers/${params?.serverId}/coversations/${member.id}`)
    ...
    //useEffect for handling key events when user clicks escape when user is trying to edit a message.
    useEffect(()=>{
    ...
    //onSubmit event handler when user attempts to edit a message
    ...
    return (
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            ...
            <div
                ...
                <DiscordAvatar src={member.profile.imageUrl}/>
            </div>
            <div className="flex flex-col w-full">
                ...
                {/**Check if message has a pdf attached to it */}
                {isPDF && (
                ...
                {/**Check if ther is no file url uploaded or not on edit mode */}
                {!fileUrl && !isEditing && (
                    <p className={cn(
                                            ...
                                            <FormControl>
                                                <div className="relative w-full">
                                                    <Input 
                                                        ...
                                                        border-none border-0 focus-visible:ring-offset-0 text-zinc-600
                                                        dark:text-zinc-200"
