...
export const ServerMember = ({
    ...
    //open a conversation page when user clicks on a member
    const onClick = () => {
    ...
    return (
        ...
        >
            <DiscordAvatar src={member.profile.imageUrl} className="h-8 w-8 md:h-8 md:w-8"/>
            <p
                className={cn("font-semibold text-sm text-zinc-600 dark:group-hover:text-zinc-300 transition",
